...
public class RobotContainer {
  ...
  private void configureShuffleboard() {
    ...
    SmartDashboard.putData("Drive Trajectory Absolute", new DriveTrajectory(CoordType.kAbsolute, StopType.kBrake, 
        trajectoryCache.cache[TrajectoryType.test.value], driveTrain, log));  
    SmartDashboard.putData("Drive Trajectory", new DriveTrajectory(
          CoordType.kAbsolute, StopType.kBrake,
          new TrajectoryFacing(rotationFront, rotationFront,
            TrajectoryCache.calcTrajectory( "Tryout-2024", 0.4, 0.4,
              new Pose2d(Units.inchesToMeters(43), Units.inchesToMeters(90), new Rotation2d(0)),
              List.of(
                new Translation2d(Units.inchesToMeters(150), Units.inchesToMeters(90)),
                new Translation2d(Units.inchesToMeters(172), Units.inchesToMeters(60)),
                new Translation2d(Units.inchesToMeters(150), Units.inchesToMeters(38)),
                new Translation2d(Units.inchesToMeters(128), Units.inchesToMeters(60)),
                new Translation2d(Units.inchesToMeters(150), Units.inchesToMeters(90))
              ),
              new Pose2d(Units.inchesToMeters(225), Units.inchesToMeters(90), new Rotation2d(0)),
              log
            )
          ),
          driveTrain, log));
